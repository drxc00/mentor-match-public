...
import AdditionalFeedbackFormsBtn from "@/components/AdditionalFeedbackFormsBtn"
...
export const columns: ColumnDef<Session>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            return (
                session.status != "pending" ? (
                    <AdditionalFeedbackFormsBtn sessionId={session._id} disabled={false}/>
                    // userId, selectedSession, tutorOfSession
                ) : (
                    <AdditionalFeedbackFormsBtn sessionId={session._id} disabled={true}/>
                )
            )
        },
    }
